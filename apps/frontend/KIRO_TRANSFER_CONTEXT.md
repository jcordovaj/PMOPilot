...
**Estado del Backend**: Desarrollo no iniciado, se debe ajustar a lógica y endpoints del frontend (Python 3.11.6, FastAPI, Pydantic v2, Uvicorn, Amazon DynamoDB (boto3), Gemini SDK (google-genai))
